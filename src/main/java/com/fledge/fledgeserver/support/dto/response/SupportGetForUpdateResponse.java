...
public class SupportGetForUpdateResponse {
    ...
    public SupportGetForUpdateResponse(Long memberId, String nickname, String title, String reason, String item, String purchaseUrl, int price, List<String> images, int checkPeriod, int checkCount, LocalDate expirationDate) {
